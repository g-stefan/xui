...
foreach($items as $value){
	...
	//
		echo "<div class=\"xui grid -col -x4 -align-center\">";
			if(strlen($value)){
				echo "<form>";
					echo "<select class=\"xui form-select ".$cssClass." -required -multiple\" id=\"form-select-".$value."-required\" name=\"form-select-".$value."-required\" ".$isDisabled." data-xui-select-theme=\"-".$value." -multiple\"  multiple=\"multiple\" style=\"width:128px;\">";
