...
<html lang="en-GB" class="xui">
	<head>
		...
		<link rel="stylesheet" href="css/xui-panel.css">
		<link rel="stylesheet" href="css/xui-alert.css">
		<link rel="stylesheet" href="css/xui-notify.css">
		<style>
	...
	<script>
		window.addEventListener("load", function(){
			document.getElementById("button-open-notify-1").addEventListener("click", function(){
