...
<body class="xui-overlay-scrollbars bg-xui-1-aluminium-1-500" data-overlayscrollbars-initialize>
	...
	<?php include("colors-page-1.php"); ?>
	<?php include("colors-page-2.php"); ?>
	<?php include("colors-page-3.php"); ?>
	<?php include("colors-page-4.php"); ?>
	<?php include("colors-page-5.php"); ?>
	<?php include("colors-page-6.php"); ?>
	<?php include("colors-page-7.php"); ?>
	<?php include("colors-page-8.php"); ?>
	<?php include("colors-page-9.php"); ?>	
