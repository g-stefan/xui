...
<html lang="en-GB" class="xui">
	<head>
		...
		<link rel="stylesheet" href="css/xui-form-file.css">
		<link rel="stylesheet" href="css/xui-form-image.css">
		<style>
	...
	<script>
		window.addEventListener("load", function(){
			$("#form-image-component").cropit({ imageBackground: true, allowDragNDrop: false, imageBackgroundBorderWidth: 16 });
		});
	</script>
	</body>
</html>
