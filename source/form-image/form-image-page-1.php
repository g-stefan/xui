...
<form>
	<div class="xui form-image" id="form-image-component">
		...
		<div class="xui _delete button -icon -size-x32 -circle -danger -transparent -effect-ripple" onclick="return false;" style="margin: 3px 3px 3px 3px;"><i class="material-icons">delete</i></div>
		<div class="xui form-file">
			...
			<button type="button" class="xui button -outline -icon -secondary"><i class="material-icons">close</i></button>
		</div>
	</div>
</form>
</div>
