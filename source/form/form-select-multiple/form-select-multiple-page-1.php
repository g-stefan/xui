...
<div class="xui-page --A4 --presentation shadow-md mx-auto">
	...
	foreach ($items as $value) {
		...
		if (strlen($value)) {
			echo "<form>";
			echo "<select class=\"xui-form-select " . $cssClass . " --multiple w-48\" id=\"form-select-" . $value . "\" name=\"form-select-" . $value . "\" " . $isDisabled . " multiple=\"multiple\" data-xui-select-theme=\"--" . $value . "\">";
