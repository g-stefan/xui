...
<head>
	...
	<link rel="stylesheet" href="../vendor/jquery.tag-editor.css">
...
<body class="xui-overlay-scrollbars bg-xui-1-aluminium-1-500" data-overlayscrollbars-initialize>
	...
	<script src="../vendor/jquery.caret.min.js" defer></script>
	<script src="../vendor/jquery.tag-editor.min.js" defer></script>
