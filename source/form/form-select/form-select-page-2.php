...
<div class="xui-page --A4 --presentation shadow-md mx-auto">
	...
	foreach ($items as $value) {
		...
		if (strlen($value)) {
			echo "<form>";
			echo "<select class=\"xui-form-select " . $cssClass . " --required\" id=\"form-select-" . $value . "-required\" name=\"form-select-" . $value . "-required\" " . $isDisabled . " data-xui-select-theme=\"--" . $value . "\">";
