...
<body class="xui-overlay-scrollbars bg-xui-rock-1-500" data-overlayscrollbars-initialize>
	...
	<script src="../vendor/select2.full.min.js" defer></script>
	<script src="../vendor/maximize-select2-height.min.js" defer></script>	
	...
	<!-- keep classes on css purge -->
	<div class="hidden select2"></div>
	<div class="hidden select2-selection"></div>
	<div class="hidden select2-dropdown"></div>
	<div class="hidden select2-container"></div>
	<div class="hidden select2-results__option"></div>
	<div class="hidden select2-container--default"></div>
	<div class="hidden select2-container--open"></div>
