...
<html lang="en-GB" class="xui">
	<head>
		...
		<link rel="stylesheet" href="css/xui-form-text-material.css">
		<style>
	...
	<?php include("form-textarea-material-page-1.php"); ?>
	<?php include("form-textarea-material-page-2.php"); ?>

	<script src="js/xui-core.min.js" defer></script>
	<script src="js/xui-form-text-material.min.js" defer></script>
	</body>
</html>
