...
<body class="xui-overlay-scrollbars bg-xui-rock-1-500" data-overlayscrollbars-initialize>
	...
	<?php include("application-toolbar-page-1.php"); ?>	
	...
	<script>
		window.addEventListener("load", function(){
			XUI.App.Toolbar.linkResponsive("xui-application-toolbar-responsive","xui-application-toolbar-1","xui-application-toolbar_content-1");
			XUI.App.Toolbar.linkResponsiveLeftRight("xui-application-toolbar-responsive","xui-application-toolbar-3","xui-application-toolbar_content-3-left","xui-application-toolbar_content-3-right");
		});
	</script>
</body>
