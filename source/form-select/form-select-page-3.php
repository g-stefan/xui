...
foreach($items as $value){
	...
	//
		echo "<div class=\"xui grid -col -x4 -align-center\">";
			if(strlen($value)){
				echo "<form>";
					echo "<select class=\"xui form-select ".$cssClass."\" id=\"form-select-search-".$value."\" name=\"form-select-search-".$value."\" ".$isDisabled." data-xui-select-theme=\"-".$value."\" data-xui-select-minimum-results-for-search=\"3\">";
