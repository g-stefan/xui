...
<div class="xui-dashboard --over --closed h-120" id="dashboard-mode-over">
	<!-- application-header -->
	<div class="xui-application-header">
		...
		<div class="xui-application-bar">
			<div class="xui-button --icon float-left --transparent xui-effect-ripple --toolbar" onclick="XUI.Dashboard.toggleOver('dashboard-mode-over');">
