...
<body class="xui-overlay-scrollbars bg-xui-1-aluminium-1-500" data-overlayscrollbars-initialize>
	...
	<?php include("dashboard-theme-2-page-1.php"); ?>
	<?php include("dashboard-theme-2-page-2.php"); ?>
	<?php include("dashboard-theme-2-page-3.php"); ?>
	...
	<script src="../release/xui.dashboard.min.js" defer></script>	
</body>
