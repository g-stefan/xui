...
<div class="xui-dashboard --theme-2 --over --closed overflow-visible h-120" id="xui-dashboard-mode-over">
	<!-- application-header -->
	<div class="xui-application-header">
		...
		<div class="xui-application-bar">
			<div class="xui-button --icon float-left --transparent xui-effect-ripple --toolbar" onclick="XUI.Dashboard.toggleOver('xui-dashboard-mode-over');">
		...
		<div class="xui-application-user-info">
			...
			<!-- /application-user -->
			<div class="xui-button --icon --size-x32 --circle --transparent xui-effect-ripple --toolbar" id="xui-popup-menu-user_action-3">
				<i class="lucide-chevron-down"></i>
			</div>
			<ul class="xui-menu --popup" id="xui-popup-menu-user-3">
