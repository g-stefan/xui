...
<div class="xui-dashboard --theme-2 --mini --closed overflow-visible h-120" id="xui-dashboard-mode-mini">
	<!-- application-header -->
	<div class="xui-application-header">
		...
		<div class="xui-application-user-info">
			...
			<!-- /application-user -->
			<div class="xui-button --icon --size-x32 --circle --transparent xui-effect-ripple --toolbar" id="xui-popup-menu-user_action-2">
				<i class="lucide-chevron-down"></i>
			</div>
			<ul class="xui-menu --popup" id="xui-popup-menu-user-2">
