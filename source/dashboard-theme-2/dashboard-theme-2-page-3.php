...
<div class="xui dashboard -over -closed" id="dashboard-mode-over" style="overflow:visible;">
	...
	<div class="xui app-header">
		...
		<div class="xui app-bar">
			<div class="xui button -icon -left -transparent -effect-ripple" onclick="XUI.Dashboard.toggleOver('dashboard-mode-over');">
		...
		<div class="xui app-user-info">
			...
			<!-- /app-user -->
			<div class="xui button -icon -size-x32 -circle -transparent -effect-ripple" id="popup-menu-user-action-3">
