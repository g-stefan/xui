...
<html lang="en-GB" class="xui">
	<head>
		...
		<link rel="stylesheet" href="css/xui-button-outline.css">
		<link rel="stylesheet" href="css/xui-app-toolbar.css">
		<style>
	...
	<?php include("app-toolbar-page-1.php"); ?>
	...
	<script src="js/xui-responsive-element.min.js" defer></script>
	<script src="js/xui-app-toolbar.min.js" defer></script>
	<script>
		window.addEventListener("load", function(){
			XUI.App.Toolbar.linkResponsive("xui-responsive","xui-app-toolbar-1","xui-app-toolbar_content-1");
			XUI.App.Toolbar.linkResponsiveLeftRight("xui-responsive","xui-app-toolbar-3","xui-app-toolbar_content-3-left","xui-app-toolbar_content-3-right");
		});
	</script>
	</body>
</html>
